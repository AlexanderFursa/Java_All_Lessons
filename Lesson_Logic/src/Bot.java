...
public class Bot {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (city.equalsIgnoreCase("Берлин") || city.equalsIgnoreCase("Berlin")) {
      ...
      // всё плохо
      System.out.println("К сожалению, ваш город пока не обслуживается.");
      System.out.println("Нам очень жаль, " + name + "!");
...
//      total = total + String.format("от %d.%d до %d.%d", lowEur, lowCnt, highEur, highCnt);
    ...
    System.out.println("Спасибо за заказ, " + name + "!");
    System.out.println("Ваш заказ:");
    System.out.println("Пицца: " + pizza);
    if (small) {
      System.out.println("Размер: маленькая");
    } else {
      System.out.println("Размер: большая");
    }
    ...
    System.out.println("Адрес доставки: " + building);
    System.out.println("Детали для курьера: " + addressDetails);
  }
}